...
<p align="left">
🌱 Continue mastering <strong><span style="color:#3776AB;">Python</span></strong> for data cleaning, transformation, and automation.<br>
📊 Deepen my knowledge of <strong><span style="color:#F2C811;">Power BI</span></strong> and dashboard storytelling.<br>
📚 Explore <strong>Machine Learning fundamentals</strong> for predictive analytics.<br>
🧠 Learn <strong><span style="color:#336791;">Advanced SQL</span></strong> for performance optimization and complex data queries.<br>
